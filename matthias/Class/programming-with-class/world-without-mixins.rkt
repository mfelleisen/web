...
(module mini-world racket/gui
  ...
  (define world-editor-canvas%
    (class editor-canvas% 
      (init-field 
       ...
       ;; KeyEvent -> State 
       on-key
       ;; Natural Natural MouseEvent -> State 
       on-mouse
       ;; Natural Natural MouseEvent -> Boolean 
       good-mouse?)
  ...
  (define world-pasteboard%
    (class pasteboard%
      ...
      (inherit find-first-snip delete insert lock begin-edit-sequence end-edit-sequence)
